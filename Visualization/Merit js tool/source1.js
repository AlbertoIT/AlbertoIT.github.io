...
function createTable(title, data){
	...
	var txt = "<table border='1'>"
        ...
        for (x in data) {
            ...
            txt += "<tr><td>" + data[x].tx + "</td><td><a href='https://albertoit.github.io/Visualization/Merit%20js%20tool/filterMeritLocal.html?id=" + data[x].from + "'>" + data[x].from + "</a> (<a href='https://albertoit.github.io/Visualization/Merit%20js%20tool/filterMeritLocal.html?id=" + data[x].uidFrom + "'>btk</a>)</td><td><a href='https://albertoit.github.io/Visualization/Merit%20js%20tool/filterMeritLocal.html?id=" + data[x].to + "'>" + data[x].to + "</a>(<a href='https://albertoit.github.io/Visualization/Merit%20js%20tool/filterMeritLocal.html?id=" + data[x].uidTo + "'>btk</a>)</td><td>" + data[x].merit + "</td><td>" + data[x].date + "</td><td><a href='https://bitcointalk.org/index.php?topic=" + data[x].Msg + "#" + data[x].Msg.split('.')[1] + "'>Msg</a></td></tr>";
        }
